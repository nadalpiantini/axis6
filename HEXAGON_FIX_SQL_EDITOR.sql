-- HEXAGON RESONANCE FIX FOR SUPABASE SQL EDITOR
...
DROP FUNCTION IF EXISTS get_hexagon_resonance(UUID, DATE);
...
-- RLS Policies
DROP POLICY IF EXISTS "Users can view resonance events" ON axis6_resonance_events;
...
DROP POLICY IF EXISTS "Users can create their own resonance events" ON axis6_resonance_events;
