...
export function TemperamentResults({
  ...
  const scorePercentages = Object.entries(result.scores).map(([temperament, score]) => ({
    ...
    data: temperamentData[temperament as keyof typeof temperamentData]
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <motion.div
        ...
        className="glass rounded-2xl w-full max-w-4xl max-h-[95vh] overflow-y-auto"
      >
        {/* Header */}
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white">
                    {primaryTemp.name[language]}
                  </h3>
                  <p className="text-sm text-gray-300">
                    {primaryTemp.subtitle[language]}
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-lg font-bold text-white">
                      {secondaryTemp.name[language]}
                    </h3>
                    <p className="text-sm text-gray-300">
                      {secondaryTemp.subtitle[language]}
                    </p>
                  </div>
                </div>
