                ...
                {unlockedAchievements.map((achievement) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      {achievement.icon === 'activity' && <Activity className="w-6 h-6 text-green-400" />}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {lockedAchievements.map((achievement) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      {achievement.icon === 'flame' && <Flame className="w-6 h-6 text-gray-400" />}
                      {achievement.icon === 'activity' && <Activity className="w-6 h-6 text-gray-400" />}
                      <h3 className="font-semibold text-gray-400">{achievement.title}</h3>
                    </div>
