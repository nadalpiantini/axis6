...
-- 1. Ensure is_private column exists (required for RLS policies)
...
-- axis6_chat_participants policies
...
-- 4. Fix foreign key relationships to reference axis6_profiles
...
SELECT 'EMERGENCY FIX APPLIED SUCCESSFULLY! Testing basic query...' as status;
SELECT COUNT(*) as total_participants FROM axis6_chat_participants;
