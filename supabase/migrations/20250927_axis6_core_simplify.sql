-- AXIS6 Core Simplification
-- Minimal tables for essential functionality

-- Drop existing complex tables if we're starting fresh (optional)
-- DROP TABLE IF EXISTS axis6_time_blocks CASCADE;
-- DROP TABLE IF EXISTS axis6_activities CASCADE;
